...
export default function Feedback(){
    return(
        <section className="lg:px-32 px-4 py-16 space-y-32 bg-[#dae95233]">
            <div className="flex flex-col gap-4 items-center">
                <h1 className="text-5xl text-center lg:w-[45rem] font-semibold">Our <span className="text-vert font-bold">Dhabi</span> Restaurant Happy Customers</h1>
            ...
            <div className="flex flex-col lg:flex-row gap-32 lg:gap-24">
                {
